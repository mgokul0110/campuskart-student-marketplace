    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-orange-950 px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="text-5xl font-bold bg-gradient-to-r from-orange-300 to-orange-500 bg-clip-text text-transparent drop-shadow-2xl mb-3 filter drop-shadow-[0_0_20px_rgba(249,115,22,0.5)]">Join CampusCraft! 🚀</h2>
          <p className="mt-2 text-orange-300 text-xl font-bold drop-shadow-lg">Create your account to start trading</p>
        </div>
        ...
        <div className="card bg-gradient-to-br from-gray-900 to-black border-orange-500/50">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">Must be a college email address</p>
            </div>
